# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2018-08-23 22:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.IntegerField(default=100, verbose_name='图片播放顺序')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_type', models.CharField(choices=[('register', '注册'), ('forget', '找回密码')], max_length=10, verbose_name='验证类型')),
